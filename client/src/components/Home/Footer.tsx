...
export default function Footer() {
    return (
        <footer style={{ background: "#fffbeb", borderTop: "1px solid rgba(234,179,8,0.15)" }}>
            <div className="max-w-6xl mx-auto px-5 sm:px-8 py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    <div className="lg:col-span-2">
                        <Link to="/" onClick={() => scrollTo(0, 0)} className="inline-flex items-center gap-2 mb-5">
                            <span className="text-2xl">🐝</span>
                            <span className="font-medium font-serif text-xl text-gray-800">PostBee</span>
                        </Link>
                        <p className="text-sm text-gray-500 leading-relaxed max-w-xs">The AI-powered social media scheduler that helps creators and teams grow faster with less effort.</p>
                    </div>
                    {Object.entries(footerLinks).map(([category, links]) => (
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8" style={{ borderTop: "1px solid rgba(234,179,8,0.15)" }}>
                    <p className="text-xs text-gray-400">© {new Date().getFullYear()} PostBee. All rights reserved.</p>
                    <div className="flex items-center gap-6">
                        ...
                        <a href="#" className="text-xs text-gray-400 hover:text-gray-700">Sign In</a>
                    </div>
                </div>
            </div>
        </footer>
