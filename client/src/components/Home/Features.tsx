...
export default function Features() {
    return (
        <section id="features" className="py-24 bg-amber-50/60">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-serif text-4xl sm:text-5xl font-medium leading-tight text-gray-900">
                        Automate your entire
                        <br />
                        <span className="text-yellow-500 italic">social media workflow</span>
                    </h2>
                    <p className="mt-5 text-gray-500 max-w-xl mx-auto leading-relaxed">From content creation to scheduling — PostBee handles it all so you can focus on what matters most.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {features.map((f) => (
                        <div key={f.title} className="bg-white rounded-2xl border border-amber-100 p-6 hover:border-amber-200 hover:shadow-md hover:shadow-amber-100 group transition-all">
                            <div className="size-10 rounded-xl flex items-center justify-center mb-4 bg-yellow-50 text-yellow-600">
                                <f.icon className="size-5" />
                            </div>
