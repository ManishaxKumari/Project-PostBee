                ...
                <div className="bg-white rounded-2xl shadow-sm p-8">
                    <div className="flex flex-col items-center mb-8">
                        <Link to="/" className="flex items-center gap-2">
                            ...
                            <h1 className="text-2xl">PostBee</h1>
                        </Link>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 text-sm">
                        ...
                        <button type="submit" disabled={loading} className="w-full py-2.5 px-4 bg-linear-to-r from-yellow-500 to-amber-400 text-white rounded-full text-sm transition-all disabled:opacity-60 flex items-center justify-center gap-2">
                            {loading ? (
                                "Signing in..."
                            ) : (
                                <>
                    ...
                    <div className="mt-6 text-center text-sm text-slate-500">
                        {loginState ? (
                            <>
                                ...
                                <button onClick={() => setLoginState(false)} className="text-yellow-700 hover:text-yellow-800">
                                    Create one free
                                </button>
                            </>
                        ) : (
                            <>
                                ...
                                <button onClick={() => setLoginState(true)} className="text-yellow-700 hover:text-yellow-800">
                                    Sign In
                                </button>
                            </>
                        )}
